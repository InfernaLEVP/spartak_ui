<template>
    ...
    <div class="form-popup" id="myForm">
        ...
        <form action="/action_page.php" class="form-container" @submit="formOrder">
            ...
            <lottie-player v-show="loaderProgress" :src="loader"  background="transparent"  speed="1"  style="width: 100%; height: 100%; position: absolute; top: 0; left: 0; background: rgba(0,0,0,.85);"  loop autoplay></lottie-player>
            ...
            <div class="inputs" v-show="renderType === 'ordinary'">
                ...
                <input type="tel" placeholder="Телефон" name="phone" v-maska="'+7 (###) ###-##-##'" required v-model="phone">
                <div class="line"></div>
