            ...
            <form id="myform" action="/action_page.php" class="form-container" @submit="formOrder" autocomplete="off">
                ...
                <div class="result" v-show="renderType === 'fullMatch'">
                    ...
                    <p class="text1922">Командная заявка заполняется капитаном. 16 команд принимает участие в рамках
                        ...
                        Формат игры 4х4, без вратарей. Один матч длится 5 минут. Победившая команда остаётся на площадке,
    ...
    computed: {
        ...
        additionalText() {
            if (this.formType === '1922') {
                return `
                    <p class="text1922">Формат турнира:</p>
                    <p class="text1922">Командная заявка заполняется капитаном. 16 команд принимает участие в рамках выбранного временного слота. Формат игры 4х4, без вратарей. Один матч длится 5 минут. Победившая команда остаётся на площадке, проигравшая покидает поле и становится последней в очереди</p>
                `;
            } else if (this.formType === 'media') {
                return '';
            } else if (this.formType === 'remind') {
